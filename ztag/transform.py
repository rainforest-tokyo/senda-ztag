...
class ZGrabTransform(ZMapOldTransform):
    """
    ...
    def get_scan_data(self, obj):
        ...
        """
        try :
            self.scan_id = list(obj["data"].keys())[0]
        except :
            pass
