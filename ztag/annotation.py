...
class Metadata(object):
    ...
    def to_dict(self, with_description=True):
        ret = {"local_metadata":None,"global_metadata":None,"tags":None}
        ret["local_metadata"] = self.local_metadata.to_dict(with_description)
        ret["global_metadata"] = self.global_metadata.to_dict(with_description)
        ret["tags"] = list(self.tags)
        return ret
